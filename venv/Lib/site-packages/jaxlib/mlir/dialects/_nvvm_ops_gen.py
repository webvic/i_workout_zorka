...
def read_ptx_sreg_envreg0(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg0Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg1(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg1Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg2(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg2Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg3(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg3Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg4(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg4Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg5(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg5Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg6(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg6Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg7(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg7Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg8(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg8Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg9(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg9Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg10(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg10Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg11(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg11Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg12(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg12Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg13(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg13Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg14(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg14Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg15(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg15Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg16(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg16Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg17(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg17Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg18(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg18Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg19(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg19Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg20(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg20Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg21(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg21Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg22(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg22Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg23(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg23Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg24(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg24Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg25(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg25Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg26(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg26Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg27(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg27Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg28(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg28Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg29(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg29Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg30(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg30Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_envreg31(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(EnvReg31Op(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_globaltimer(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GlobalTimerOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_gridid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridIdOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_lanemask_eq(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneMaskEqOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_lanemask_ge(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneMaskGeOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_lanemask_gt(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneMaskGtOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_lanemask_le(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneMaskLeOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_lanemask_lt(res, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneMaskLtOp(res=res, loc=loc, ip=ip))
...
def read_ptx_sreg_nsmid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SmDimOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_smid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SmIdOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nwarpid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WarpDimOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_warpid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WarpIdOp(res=res, range=range, loc=loc, ip=ip))
